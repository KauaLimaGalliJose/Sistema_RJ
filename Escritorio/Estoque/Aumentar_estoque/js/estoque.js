...
function submitForm(formulario, aquivo) {
    ...
    .then(data => {
        ...
        //para voltar a pagina dos estoques 
        window.location.href = '../aumentarEstoque.php';
    })
    .catch(error => {
...
// editar tabela para salvar de uma certa maneira 
function enviar_local(resposta){
    let input_local = document.getElementById('local');
    input_local.value = resposta;
}
