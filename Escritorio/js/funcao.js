...
export function voltar(contador_P, contador_Pg, contador_Pe) {
    ...
    //PF
        if (contador_P == 0){
            CreateCookie('Pfverificador','PF' + 1 + '-' + document.getElementById('entrega').value ,0.000012);
    ...
    //PG
        if (contador_Pg == 0){
            CreateCookie('Pfverificador','PG' + 1 + '-' + document.getElementById('entrega').value ,0.000012);
        } 
        else{   
    ...
    //PE
        if (contador_Pe == 0){
            CreateCookie('Pfverificador','PE' + 1 + '-' + document.getElementById('entrega').value ,0.000012);
        } 
        else{
