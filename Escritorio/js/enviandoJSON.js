...
export function enviandoJson(dataDigitadaSplit1,dataDigitadaSplit2) {
    ...
    if(letras == "PF"){
        ...
        enviarParaJson('pedidosjsonpg.json', select.options[select.selectedIndex].text + '-' + dataDigitadaSplit2 + '/' + dataDigitadaSplit1, "torno");
    }
    else if(letras == "PE"){
        enviarParaJson('pedidosjsonpe.json', select.options[select.selectedIndex].text + '-' + dataDigitadaSplit2 + '/' + dataDigitadaSplit1, "torno");
    }
