...
<?php 
    function pesquisaPedidosDataImagem($resultado,$conectar,$dataDigitada) {
        ...
        while ($dadosImagem = mysqli_fetch_assoc($imagemConectar)) {
                ...
                <?php 
                    if($dataDigitada == $data){
                        ?><button class = 'Pdf' id="editar" type="button"><a class="PdfAncora" href="<?php echo './phpScripts/editarPedido.php?idpedidos=' . $dadosImagem['idpedidos'] ; ?>">Editar</a></button><?php
                    }
                ?>
                </div>
                <?php
        ...
        while ($dadosImagemPg = mysqli_fetch_assoc($imagemConectarPg)) {
                ...
                <?php 
                    if($dataDigitada == $data){
                        ?><button class = 'Pdf' id="editar" type="button"><a class="PdfAncora" href="<?php echo './phpScripts/editarPedido.php?idpedidos=' . $dadosImagemPg['idpedidos'] ; ?>">Editar</a></button><?php
                    }
                ?>
                </div>
                <?php
        ...
        while ($dadosImagemPe = mysqli_fetch_assoc($imagemConectarPe)) {
                ...
                <?php 
                    if($dataDigitada == $data){
                        ?><button class = 'Pdf' id="editar" type="button"><a class="PdfAncora" href="<?php echo './phpScripts/editarPedido.php?idpedidos=' . $dadosImagemPe['idpedidos'] ; ?>">Editar</a></button><?php
                    }
                ?>
                </div>
                <?php
...
<?php
    function pedidosData($conectar,$resultado,$pesquisa){
            ...
            if($pesquisa !== ''){
                ...
                //PF
                $pedidosAntigosPf = "SELECT RIGHT(idpedidos,5) AS idpedido, imagem, descricaoPedido, idpedidos, numF, numeM, largura, gravacaoInterna, gravacaoExterna, nomePedido FROM pedidosp WHERE contadorpf != 0 AND data_digitada = '$resultado' ORDER BY contadorpf ASC";
                $pedidosAntigosDadosPf = mysqli_query($conectar, $pedidosAntigosPf);

                //PG
                $pedidosAntigosPg = "SELECT RIGHT(idpedidos,5) AS idpedido, imagem, descricaoPedido, idpedidos, numF, numeM, largura, gravacaoInterna, gravacaoExterna, nomePedido FROM pedidospg WHERE contadorpg != 0 AND data_digitada = '$resultado' ORDER BY contadorpg ASC";
                $pedidosAntigosDadosPg = mysqli_query($conectar, $pedidosAntigosPg);

                //PE
                $pedidosAntigosPe = "SELECT RIGHT(idpedidos,5) AS idpedido, imagem, descricaoPedido, idpedidos, numF, numeM, largura, gravacaoInterna, gravacaoExterna, nomePedido FROM pedidospe WHERE contadorpe != 0 AND data_digitada = '$resultado' ORDER BY contadorpe ASC";
        ...
        while ($dadosImagemPf = mysqli_fetch_assoc($imagemConectarPf)) {
                ...
                <?php 
                    if($resultado == date('Y-m-d')){
                        ?><button class = 'Pdf' id="editar" type="button"><a class="PdfAncora" href="<?php echo './phpScripts/editarPedido.php?idpedidos=' . $dadosImagemPf['idpedidos'] ; ?>">Editar</a></button><?php
                    }
                ?>
                </div>
                <?php
