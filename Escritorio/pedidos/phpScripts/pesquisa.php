...
<?php ////////////////////////////////////////////////////////////////////-- Pesquisa Do Dia --////////////////////////////////////////////////////////////////////////?>
<?php 
function pesquisa($resultado,$conectar,$dataSplit , $tabela_nome , $contador){
    
    if(isset($resultado) !== ''){

        $pesquisaDados = "SELECT RIGHT(idpedidos,5) AS idpedido, 
        imagem, PedraF, PedraM, parEstoqueF, parEstoqueM, descricaoPedido , descricaoAlianca, idpedidos, numF, numeM, largura, gravacaoInterna, gravacaoExterna, nomePedido 

        FROM $tabela_nome WHERE $contador != 0 
        AND (idpedidos LIKE '%$resultado%' OR nomePedido LIKE '%$resultado%')";
...
<?php 
    function pesquisaImagem($resultado,$conectar,$dataSplit , $tabela_nome , $contador){

        $imagem = "SELECT RIGHT(idpedidos,5) AS idpedido, 
        imagem, descricaoPedido, idpedidos, numF, numeM, largura, gravacaoInterna, gravacaoExterna, nomePedido, pdf
