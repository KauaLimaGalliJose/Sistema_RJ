...
async function salvarCheckbox(checkbox , caminho) {
    ...
    if(checkbox.checked){
        ...
        await verificarPedidosJson(pedidos ,'SalvarNumeroPedidos.php' ,  checkboxSplit[0] + "feito" , "nao" , checkbox.classList[1]);
        //console.log('true')
    }
        ...
        await verificarPedidosJson(pedidos ,'SalvarNumeroPedidos.php' ,  checkboxSplit[0] + "naoFeito" , "nao" , checkbox.classList[1]);
        //console.log('false')
    }
}

function enviarFormulario(formId , caminho) {
    ...
    fetch( '../../scripts/phpGlobal/backEnd/pedidosPesquisa/enviarNumeroEstoque.php', { // Envia para o mesmo arquivo PHP
        method: 'POST',
        body: formData
    })
