...
function criarAtualizar_pedido_estoque($n,$estoquePersonalizado,$nomeTabela,$imagem,$peso,$descricao,$conectar){
    ...
    $sql_estoque_Pedido = "SELECT * FROM $nomeTabela WHERE nome = ? AND data_digitada = '$data'";
    ...
    // esse é para contar 
    $sql_estoque_Pedido_count = "SELECT COUNT(*) FROM $nomeTabela WHERE nome = ? AND data_digitada = '$data'";
