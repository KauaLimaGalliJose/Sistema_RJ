<?php
    ...
    $pedidos_outros = new Pedidos_Quantidade();
...
<?php 
    ...
    $pedidos_outros->setData_Inicio($dataInicio->format('Y-m-d'));
    ...
    $pedidos_outros->setData_Termino($dataTermino->format('Y-m-d'));

    // Tipos de Pedidos
    $pedidos->setTipo("PF");
    $pedidosG->setTipo("PG");
    $pedidosE->setTipo("PE");
    $pedidos_outros->setTipo("pedidos");

    //Tem ou não estoque
    $pedidos->setEstoque($estoque);
    $pedidosG->setEstoque($estoque);
    $pedidosE->setEstoque($estoque);
    $pedidos_outros->setEstoque($estoque);

    //Montando SQL
    $pedidos->montar_sql();
    $pedidosG->montar_sql();
    $pedidosE->montar_sql();
    $pedidos_outros->montar_sql();
    ...
    $pedidosArrayoutros = $pedidos_outros->mostrar_pedidos_por_data($conectar);

    
    ksort($pedidosArray);
    ksort($pedidosArrayG);
    ksort($pedidosArrayE);
    ksort($pedidosArrayoutros);
    
    // juntando todos os arrays dos Pedidos
    $pedidosTotais_array = [$pedidosArray ,$pedidosArrayG , $pedidosArrayE , $pedidosArrayoutros];
    $final_array = [];
            ...
            <li class="nav-item mb-3">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                        ...
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <label class="collapse-item" ><b>Pedidos</b>
                                <select name="pedidos" class="w-80  form-control form-control-sm " onchange="this.form.submit()" >
                                    <option >Todos</option>
                                    <option <?php echo (isset($_POST['pedidos']) && $_POST['pedidos'] == 'PF') ? 'selected' : ''; ?> >PF</option>
                                    <option <?php echo (isset($_POST['pedidos']) && $_POST['pedidos'] == 'PG') ? 'selected' : ''; ?> >PG</option>
                                    <option <?php echo (isset($_POST['pedidos']) && $_POST['pedidos'] == 'PE') ? 'selected' : ''; ?> >PE</option>
                                </select>
                            </label>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">PESO DOS ESTOQUES JÁ VENDIDOS
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php 
                                                    ...
                                                    if($pedidos_input == "Todos"){
                                                       ...
                                                       $peso =  $pedidos->mostrar_peso_pedidos($conectar ,"Peso");
                                                       $peso +=  $pedidosG->mostrar_peso_pedidos($conectar ,"Peso");
                                                       $peso +=  $pedidosE->mostrar_peso_pedidos($conectar ,"Peso");
                                                        print($peso/1000 . " Kg (" . $peso ." g)");
                                                    }
                                                    elseif($pedidos_input == "PF" ){
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold  text-uppercase mb-1">
                                                Comparação de Vendas Passadas</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php 
                                                    $comparacao = $pedidos->comparacao_vendas($conectar);
                                                    $comparacao += $pedidosG->comparacao_vendas($conectar);
                                                    $comparacao += $pedidosE->comparacao_vendas($conectar);

                                                    if($comparacao < 0){

                                                        ?> <label class="text-danger" ><?=  $comparacao . " Pares"; ?></label> <?php
                                                    }
                                                    elseif($comparacao == 0){
                                                        ...
                                                        ?> <label class="text-success" >+<?=  $comparacao . " Pares"; ?></label> <?php
                                                    }
                                        ...
                                        <div class="col-auto">
                                                <?php 
                                                    ...
                                                    if($comparacao < 0){
                                                        ...
                                                        ?> <i class="fas fa-arrow-down fa-2x text-danger"></i><?php
                                                    }
                                                    elseif($comparacao == 0){

                                                        ?> <i class="fas fa-minus fa-2x text-gray"></i> <?php
                                                    }
                                                    else{
                                                        ?> <i class="fas fa-arrow-up fa-2x text-success"></i> <?php
                                                    }
                        ...
                        <div class="col-xl-4 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Pedidos Peso</h6>
                ...
                <div class="col-xl-4 col-md-6 mb-4">
                    <div class="card bg-gradient-blue shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="h4 text-sm font-weight-bold text-primary text-uppercase mb-1">
                                        Fluxo de Vendas </div>
                                        </br>
                                        <div class="card-body shadow h4 mb-0 font-weight-bold text-gray-800">PF =
                                            <?php
                                                $comparacao_PF = $pedidos->comparacao_vendas($conectar);

                                                if($comparacao_PF < 0){
                                                    ?> <label class="text-danger" ><?=  $comparacao_PF . " Pares"; ?></label> <?php
                                                }
                                                elseif($comparacao_PF == 0){
                                                    ?> <label>0</label> <?php
                                                }
                                                else{
                                                    ?> <label class="text-success" >+<?=  $comparacao_PF . " Pares"; ?></label> <?php
                                                }
                                            ?>
                                        </div>
                                        </br>
                                        <div class="card-body shadow h4 mb-0 font-weight-bold text-gray-800">PG =
                                            <?php
                                                $comparacao_PG = $pedidosG->comparacao_vendas($conectar);

                                                if($comparacao_PG < 0){
                                                    ?> <label class="text-danger" ><?=  $comparacao_PG . " Pares"; ?></label> <?php
                                                }
                                                elseif($comparacao_PG == 0){
                                                    ?> <label>0</label> <?php
                                                }
                                                else{
                                                    ?> <label class="text-success" >+<?=  $comparacao_PG . " Pares"; ?></label> <?php
                                                }
                                            ?>
                                        </div>
                                        </br>
                                        <div class="card-body shadow h4 mb-0 font-weight-bold text-gray-800">PE =
                                            <?php
                                                $comparacao_PE = $pedidosE->comparacao_vendas($conectar);

                                                if($comparacao_PE < 0){
                                                    ?> <label class="text-danger" ><?=  $comparacao_PE . " Pares"; ?></label> <?php
                                                }
                                                elseif($comparacao_PE == 0){
                                                    ?> <label>0</label> <?php
                                                }
                                                else{
                                                    ?> <label class="text-success" >+<?=  $comparacao_PE . " Pares"; ?></label> <?php
                                                }
                                            ?>
                                        </div>
                                </div>
